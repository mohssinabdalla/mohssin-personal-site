    ...
    <section id="skills" className="py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/40 mt-4 text-sm">{t('skills.subtitle')}</p>
        </div>
            ...
            <div key={group.groupKey} className="card">
              ...
              <div className="flex flex-wrap gap-2">
                {t(group.skillsKey, { returnObjects: true }).map((skill) => (
                  <span key={skill} className="text-sm px-3 py-1.5 rounded-lg text-white/70 transition-all duration-200 hover:text-white cursor-default"
